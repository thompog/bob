...
program_name = "bbbk"
where = {"downloads": f"C:\\Users\\{user}\\{program_name}\\downloads", "main": f"C:\\Users\\{user}\\{program_name}\\main", "main_exe": f"C:\\Users\\{user}\\{program_name}\\main\\{program_name}.py", "logging": f"C:\\Users\\{user}\\{program_name}\\logging", "log": f"C:\\Users\\{user}\\{program_name}\\logging\\log.txt", "parts": f"C:\\Users\\{user}\\{program_name}\\parts", "main_starter": f"C:\\Users\\{user}\\{program_name}\\parts\\starter.bat"}
